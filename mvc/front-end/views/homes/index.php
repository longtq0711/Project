                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-new-pro mb-30 text-center">
                        <div class="product-img">
                            <a href="../products/products_detail.php"><img src="assets/img/gallery/new_product1.png" alt=""></a>
                        </div>
                        <div class="product-caption">
                            <h3><a href="../products/products_detail.php">Thermo Ball Etip Gloves</a></h3>
                            <span>$ 45,743</span>
                        </div>
                    </div>
                </div>
