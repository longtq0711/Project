...
class Order extends Model {
    ...
    public function insertOrder(){
        ...
        // + Thực thi: execute, do yêu cầu bài toán, sau khi lưu orders thành công, cần lấy ra id của
        //order vừa lưu để insert tiếp vào bảng order_details, nên hàm này cần trả về id ủa chính nó sau khi
        //insert
